...
function getTables(){
    $mysqli = connect();
    $res = $mysqli->query("SELECT * FROM by_gender ");
		...
		<div class="right">
			...
			<table style="width: 100%;">	
                <tr>
                    <th>Global Rank</th>
                    <th>Country</th>
                    <th>Male Unemployment Rate</th>
                    <th>Female Unemployment Rate</th>
						    ...
						    <div class="product">
							    ...
							    <div class="right">
                                        ...
                                        <tr>
								            ...
								            <td class="rate"><?php echo $tab['Male_unemployment'] ;?></td>
                                            <td class="rate"><?php echo $tab['Female_unemployment'] ;?></td>
